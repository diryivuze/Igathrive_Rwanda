        ...
        >
          <div className="relative">
            <img
              ...
              ${isCollapsed ? 'w-8 h-8' : 'w-12 h-12'}`} // Responsive admin image
            />
            <div
          ...
          {!isCollapsed && (
            <div className="flex-1 min-w-0">
              <h2 className="font-bold truncate">{userinfo?.user_info?.username}</h2>
              <p className="text-sm text-slate-400 truncate">{userinfo?.user_info?.role}</p>
            </div>
          )}
        </div>
      </div>
