  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (req.status === 200) {
        ...
        if (req.data?.user_info?.role == "student") {
          window.location.href = "/student-dashboard";
        } else if (req.data?.user_info?.role == "mentor") {
          window.location.href = "/mentor-dashboard";
        } else if (req.data?.user_info?.role == "admin") {
          window.location.href = "/admin-dashboard";
        }
      }
      setLoading(false);
    } catch (err) {
      setError(err.response?.data?.detail || "Failed to process login request");
      setLoading(false);
    }
  };
                ...
                <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-950 to-blue-400 text-white p-12 flex-col justify-center items-center relative overflow-hidden">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <p className="text-xl mb-8">
                      &ldquo;Empowering you to thrive with the skills of
                      tomorrow.&rdquo;
                    </p>
